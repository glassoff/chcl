...
function itemsList(parent) {
    rpcNode = $('treeRoot'); 
    if (rid == '') return;     
    rpcNode.innerHTML="<div class='loading'>Загрузка городов...</div>"; 
    new Ajax('index.php?a=900&ajaxcmd=getitemlist&parent='+parent, {method: 'get',onComplete:rpcLoadData}).request();
}
...
var widgetParams = {};          // name = description;datatype;default or list values - datatype: int, string, list : separated by comma (,)
    ...
    widgetParams['string']      = '&format=String Format;list;Upper Case,Lower Case,Sentence Case,Capitalize,URL path';
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    ...
    <td align="left"><span style="font-family:'Courier New', Courier, mono">&nbsp;&nbsp;</span><select name="type" size="1" class="inputBox" style="width:300px;" onChange='documentDirty=true;'>
            ...
            <option value="ajaxitemselector" <?php  echo ($content['type']=='ajaxitemselector')? "selected='selected'":""; ?>>Ajax Catalog Item Selector</option>
	        <option value="image" <?php     echo ($content['type']=='image')? "selected='selected'":""; ?>>Image</option>
            <option value="uploadimage" <?php     echo ($content['type']=='uploadimage')? "selected='selected'":""; ?>>Image upload</option>
...
<!--
  ...
  <tr>
    ...
    <td align="left" nowrap="nowrap"><span style="font-family:'Courier New', Courier, mono">&nbsp;&nbsp;</span><textarea name="elements" type="text" class="inputBox" rows="5" style="width:300px;" onChange='documentDirty=true;'><?php echo htmlspecialchars($content['elements']);?></textarea><img src="media/style/<?php echo $manager_theme ? "$manager_theme/":""; ?>images/icons/bkmanager.gif" width="17" height="18" alt="<?php echo $_lang['tmplvars_binding_msg']; ?>" onclick="alert(this.alt)" style="cursor:hand" /></td>
  </tr>
  <tr>
