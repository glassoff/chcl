      ...
      <div class="tab-page" id="tabPage4">
        ...
        <table border="0" cellspacing="0" cellpadding="3">
          ...
          <tr>
            ...
            <td> <textarea name="webemail_signature" style="width:100%; height: 120px;"><?php echo $webemail_signature;?></textarea> </td>
          </tr>
          ...
          <tr>
            <td nowrap class="warning"><b><?php echo $_lang["webpwdremindersubject_title"] ?></b></td>
            <td ><input onchange="documentDirty=true;" type='text' maxlength='255' style="width: 250px;" name="webpwdreminder_subject" value="<?php echo isset($webpwdreminder_subject) ? $webpwdreminder_subject : "Your login details" ; ?>" /></td>
          </tr>
          ...
          <tr>
            <td nowrap class="warning"><b><?php echo $_lang["webchangepassword_emailsubject_title"] ?></b></td>
            <td ><input onchange="documentDirty=true;" type='text' maxlength='255' style="width: 250px;" name="webchangepassword_emailsubject" value="<?php echo isset($webchangepassword_emailsubject) ? $webchangepassword_emailsubject : "Your login details" ; ?>" /></td>
          </tr>
          ...
          <tr>
            <td nowrap class="warning" valign="top"><b><?php echo $_lang["webchangepassword_title"] ?></b></td>
            <td> <textarea name="webchangepassword_message" style="width:100%; height: 120px;"><?php echo isset($webchangepassword_message) ? $webchangepassword_message : $_lang["system_email_webreminder"] ?></textarea> </td>
          </tr>
          <tr>
            <td width="200">&nbsp;</td>
            <td class='comment'><?php echo $_lang["webchangepassword_message"] ?></td>
          </tr>
