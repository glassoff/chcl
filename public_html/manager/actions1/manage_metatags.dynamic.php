...
<div class="sectionHeader"><?php echo $_lang['metatags'] ;?></div><div class="sectionBody">
	  ...
	  <tr>
		...
		<table border="0" cellspacing="1">
		  <tr>
			...
			<td valign="top"><?php echo $_lang['tag'];?><br>
			...
			<textarea  name="tagvalue" class="inputBox" rows="3" style="width:300px;" ></textarea>
	...
	<?php
		...
		<input name='tag[]' type='checkbox' value='[+id+]'/><img src='media/images/icons/comment.gif' width='16' height='16' align='absmiddle' /></a>||".
...
<?php
	...
	$grd->colTypes="template:<input id=\"delete[+id+]\" name=\"delete_keywords[[+id+]]\" type=\"checkbox\"  />||".
				   ...
				   "template:<input type=\"hidden\" name=\"orig_keywords[keyword[+id+]]\" value=\"[+keyword+]\" />
				   <textarea  name=\"rename_keywords[keyword[+id+]]\" class=\"inputBox\" rows=\"1\" style=\"height:40px;width:100%;\" >[+keyword+]</textarea>";
	echo $grd->render();
?>
	<table border=0 cellpadding=2 cellspacing=0>
		<tr><td colspan="5">&nbsp;</td></tr>
