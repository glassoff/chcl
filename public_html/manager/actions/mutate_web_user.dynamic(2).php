		...
		<table border="0" cellspacing="0" cellpadding="3">
		  ...
		  <tr>
		   ...
		   <tr>
			...
			$lines = array();
			$lines[] = '<select name="user_region">';	
			$lines[] = '<option value="">-</option>';
			if ($rs && mysql_num_rows($rs)>0) {
				while ($row = mysql_fetch_assoc($rs)) {			
					if ($userdata['region_id'] == $row['id']) $lines[] = '<option value="'.$row['id'].'"  selected>'.$row['name'].'</option>';
		   ...
		   <tr>
			<td><?php echo $_lang['user_postcode']; ?>:</td>
			<td>&nbsp;</td>
			<td>
			<input type="text" name="user_postcode" class="inputBox" style="width:300px" value="<?php echo  isset($_POST['user_postcode']) ? $_POST['user_postcode'] : $userdata['user_postcode']; ?>" onChange='documentDirty=true;'>			
			</td>
		  </tr>
		   <tr>
			...
			<td>&nbsp;</td>
			<td>
			<input type="text" name="user_city" class="inputBox" style="width:300px" value="<?php echo  isset($_POST['user_city']) ? $_POST['user_city'] : $userdata['user_city']; ?>" onChange='documentDirty=true;'>			
			</td>
		  </tr>
		  
		  <tr>
			<td><?php echo $_lang['user_address']; ?>:</td>
			<td>&nbsp;</td>
			<td>
			<textarea name="user_address" class="inputBox" onChange='documentDirty=true;' style="width:300px;height:60px;"><?php echo  isset($_POST['user_address']) ? $_POST['user_address'] : $userdata['user_address']; ?></textarea> >			
			</td>
		  </tr>
