...
if (isset($_REQUEST['search']) && intval($_REQUEST['search']) == 1 && 
	...
	$_SESSION['ec_ul_search']['ec_user_town'] = $_POST['ec_user_town'];
	$group_id = 0;
...
if (isset($_SESSION['ec_ul_search'])) {
	...
	$search_user_town = $_SESSION['ec_ul_search']['ec_user_town'];
	...
	$sqladd .= $search_user_town!="" ? "and  wua.town LIKE '%$search_user_town%' " : " " ;
		...
		<div class="tab-page" id="tabSearch">
			...
			<table width="100%" border="0">
			  <tr>
			   ...
			   <tr>
			    <td wlnameth="120">Город</td>
			    <td wlnameth="20">&nbsp;</td>
			    <td wlnameth="120"><input name="ec_user_town" type="text" value="<?php echo !@empty($_SESSION['ec_ul_search']['ec_user_town']) ? $_SESSION['ec_ul_search']['ec_user_town'] : "";?>"></td>
				<td><?php echo $_lang['ec_ul_search_msg']; ?></td>
			  </tr>			    
			  <tr>
			  	<td colspan="4">
