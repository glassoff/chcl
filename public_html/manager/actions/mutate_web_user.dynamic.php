...
if ($user == 0) $user = isset($_REQUEST['cust_id']) ? intval($_REQUEST['cust_id']) : 0;
...
function rpcLoadData(response) {
   if(rpcNode != null){
        if (typeof(response) =='object') rpcNode.innerHTML = response.responseText;
        else rpcNode.innerHTML = response ; 
        rpcNode1.disabled = false;
        rpcNode.style.display = 'block';
        rpcNode.loaded = true;           
   }
}
function loadCities(rid) {
    rpcNode = document.getElementById("cities"); 
    rpcNode1 = this;
    if (rid == '') return;     
    rpcNode1.disabled = true;
    rpcNode.innerHTML="<div class='loading'>Загрузка городов...</div>";    
    new Ajax('/index-ajax.php?rid='+rid, {method: 'get',onComplete:rpcLoadData}).request();
}
...
<div class="tab-pane" id="webUserPane">
	<script type="text/javascript">
		tpUser = new WebFXTabPane(document.getElementById( "webUserPane" ));
	</script>
    <div class="tab-page" id="tabGeneral">
		...
		<table border="0" cellspacing="0" cellpadding="3">
		  ...
		  <tr>
			<td><?php echo $_lang['user_bonus']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="bonus" class="inputBox" style="width:300px" value="<?php echo htmlspecialchars(isset($_POST['bonus']) ? $_POST['bonus'] : $userdata['bonus']); ?>" onChange='documentDirty=true;'></td>
		  </tr>
 ...
 <tr>
			...
			<td>&nbsp;</td>
			<td><input type="text" name="type" class="inputBox" style="width:300px" value="<?php echo htmlspecialchars(isset($_POST['type']) ? $_POST['type'] : $userdata['type']); ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  
		   <tr>
			<td>Название организации:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="company" class="inputBox" style="width:300px" value="<?php echo htmlspecialchars(isset($_POST['company']) ? $_POST['company'] : $userdata['company']); ?>" onChange='documentDirty=true;'></td>
		  </tr>

		  <tr>
			<td><?php echo $_lang['user_fname']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="fname" class="inputBox" style="width:300px" value="<?php echo htmlspecialchars(isset($_POST['fname']) ? $_POST['fname'] : $userdata['fname']); ?>" onChange='documentDirty=true;'></td>
		  </tr>
		   <tr>
			<td><?php echo $_lang['user_sname']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="sname" class="inputBox" style="width:300px" value="<?php echo htmlspecialchars(isset($_POST['sname']) ? $_POST['sname'] : $userdata['sname']); ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  <tr>
			<td><?php echo $_lang['user_lname']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="lname" class="inputBox" style="width:300px" value="<?php echo htmlspecialchars(isset($_POST['lname']) ? $_POST['lname'] : $userdata['lname']); ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  ...
		  <tr>
			<td><?php echo $_lang['user_region']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="region" class="inputBox" style="width:300px" value="<?php echo isset($_POST['region']) ? $_POST['region'] : $userdata['region']; ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  
		  <tr>
			<td><?php echo $_lang['user_town']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="town" class="inputBox" style="width:300px" value="<?php echo isset($_POST['town']) ? $_POST['town'] : $userdata['town']; ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  
		  <tr>
			<td><?php echo $_lang['user_street']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="street" class="inputBox" style="width:300px" value="<?php echo isset($_POST['street']) ? $_POST['street'] : $userdata['street']; ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  
		  <tr>
			<td><?php echo $_lang['user_kvartira']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="kvartira" class="inputBox" style="width:300px" value="<?php echo isset($_POST['kvartira']) ? $_POST['kvartira'] : $userdata['kvartira']; ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  
		  <tr>
			<td><?php echo $_lang['user_house']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="house" class="inputBox" style="width:300px" value="<?php echo isset($_POST['house']) ? $_POST['house'] : $userdata['house']; ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  
		  <tr>
			<td><?php echo $_lang['user_korpus']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="korpus" class="inputBox" style="width:300px" value="<?php echo isset($_POST['korpus']) ? $_POST['korpus'] : $userdata['korpus']; ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  
		  <tr>
			<td><?php echo $_lang['user_postcode1']; ?>:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="postcode1" class="inputBox" style="width:300px" value="<?php echo isset($_POST['postcode1']) ? $_POST['postcode1'] : $userdata['postcode1']; ?>" onChange='documentDirty=true;'></td>
		  </tr>
		  <tr>
			<td>Карточка клиента:</td>
			<td>&nbsp;</td>
			<td><a style="" href="<?php echo MODX_SITE_URL . $userdata['clientfile']; ?>"><?php echo basename($userdata['clientfile']); ?></a></td>
		  </tr>		  
		  ...
		  <tr>
			<td>Адрес:</td>
			<td>&nbsp;</td>
			<td><textarea type="text" name="address" class="inputBox"  rows="3" style="width:300px;height:26px;" onchange='documentDirty=true;'><?php echo htmlspecialchars(isset($_POST['address']) ? $_POST['address'] : $userdata['address']); ?></textarea></td>
		  </tr>
		  <!--tr>
			<td>Бонусный код:</td>
			<td>&nbsp;</td>
			<td><input type="text" name="bonuscode" class="inputBox" style="width:300px" value="<?php echo isset($_POST['bonuscode']) ? $_POST['bonuscode'] : $userdata['bonuscode']; ?>" onChange='documentDirty=true;'></td>
		  </tr-->	
		  <tr>
			<td>Источник информации о компании:</td>
			<td>&nbsp;</td>
			<td><?php echo $userdata['infosource'];?></td>
		  </tr>		  
    ...
    <!--<div class="tab-page" id="tabPhoto">
    	<h2 class="tab"><?php echo $_lang["cust_orders"] ?></h2>
    	<script type="text/javascript">tpUser.addTabPage( document.getElementById( "tabPhoto" ) );</script>
    	<?php
    	//include(MODX_BASE_PATH."manager/ecommerce/actions/list_ec.cust_orders.dynamic.php");
    	?></div>-->
...
if($_GET['a']=='88') { // only do this bit if the user is being edited
	$sql = "SELECT * FROM $dbase.`".$table_prefix."web_groups` where webuser=".$user."";
	$rs = mysql_query($sql);
	$limit = mysql_num_rows($rs);
	for ($i = 0; $i < $limit; $i++) {
