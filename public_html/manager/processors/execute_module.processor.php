...
function evalModule($moduleCode,$params){
	global $modx;
	global $manager_theme; // by shuh
	global $_lang; // by shuh
	global $dbase; // by shuh
	global $table_prefix; //by shuh
	global $SystemAlertMsgQueque; //by shuh
	global $use_editor, $which_editor, $default_template; //by shuh
