...
$ecmenu = '';
// Catalog
   $ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=4999" target="main">' . $_lang['ec_main'] . '</a></li>';
   $ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=5000" target="main">' . $_lang['ec_catalog'] . '</a></li>';
		
// Add new item
if($modx->hasPermission('ec_new_item')) {
	$ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=5001" target="main">' . $_lang['ec_new_item'] .'</a></li>'."\n";
}
...
if($modx->hasPermission('ec_manage_1c')) { 
	$ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=5100" target="main">' . $_lang['ec_manage_1c'] . '</a></li>'."\n";
}
// Orders
if($modx->hasPermission('ec_manage_orders')) { 
	$ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=5500" target="main">' . $_lang['ec_manage_orders'] . '</a></li>'."\n";
}
// Customers
if($modx->hasPermission('ec_manage_customers')) { 
	$ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=99" target="main">' . $_lang['ec_manage_customers'] . '</a></li>'."\n";
}
...
if($modx->hasPermission('ec_payment_methods')) { 
	$ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=5202" target="main">' . $_lang['ec_pm_hdr'] . '</a></li>'."\n";
}

// Taxes
if($modx->hasPermission('ec_manage_taxes')) { 
	$ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=5300" target="main">' . $_lang['ec_manage_taxes'] . '</a></li>'."\n";
}
...
if($modx->hasPermission('ec_settings')) { 
	$ecmenu .= '<li><a onclick="this.blur();" href="index.php?a=5200" target="main">' . $_lang['ec_settings'] . '</a></li>'."\n";
}
...
if ($ecmenu) {
	echo '<li id="limenu3-2" ><a href="#menu3-2" id="menu3-2_link" onclick="new NavToggle(this); return false;">' . $_lang["ec"] . '</a>'."\n";
	echo '<ul class="subnav" id="menu3-2">' . $ecmenu . '</ul>'."\n";
	echo '</li>'."\n";
}
