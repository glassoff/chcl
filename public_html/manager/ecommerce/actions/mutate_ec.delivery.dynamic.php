...
if (!empty ($id)) {
    $tblsc = $dbase . ".`" . $table_prefix . "site_ec_delivery_types`";
...
<div class="subTitle">
   <span class="right">
   <?php echo $_lang['ec_delivery_edit_hdr']; ?></span>
   <table cellpadding="0" cellspacing="0" class="actionButtons">
        <tr>
            ...
            <?php if ($_REQUEST['a'] != 5301) {?>
            <td id="Button2"><a href="#" onclick="deletedDelivery();"><img src="media/style/<?php echo $manager_theme ? "$manager_theme/":""; ?>images/icons/delete.gif" /> <?php echo $_lang['delete']; ?></a></td>
            <?php }?>
...
<div class="sectionHeader"><?php echo $_lang['ec_delivery_form_hdr']; ?></div>
...
?>
            <table width="500" border="0" cellspacing="0" cellpadding="0">
              <tr style="height: 24px;">
                <td width='150' align="left"><span class='warning'><?php echo $_lang['ec_delivery_name']; ?></span></td>
              ...
              <tr style="height: 24px;">
                <td width='150' align="left"><span class='warning'><?php echo $_lang['ec_delivery_rate']; ?></span></td>
              ...
              <tr style="height: 24px;">
                <td valign="top" width="100" align="left"><span class='warning'><?php echo $_lang['ec_delivery_desc']; ?></span></td>
                ...
                <tr style="height: 24px;">
                <td valign="top" width="100" align="left"><span class='warning'><?php echo $_lang['ec_delivery_note']; ?></span></td>
