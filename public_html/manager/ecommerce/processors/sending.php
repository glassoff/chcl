...
$sql = "Select id, email,  fname, lname, sname, internalKey   From $dbase.`".$table_prefix."web_user_attributes` where send=1  ";
if (isset($_POST['test']) and $_POST['test']==1)  $sql .="and id=1939"; 
$rs = mysql_query($sql);
...
$sql10 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs10 = mysql_query($sql10);
    ...
    $sql11 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs11 = mysql_query($sql11);
    ...
    $sql12 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs12 = mysql_query($sql12);
    ...
    $sql13 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$sql20 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs20 = mysql_query($sql20);
    ...
    $sql21 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs21 = mysql_query($sql21);
    ...
    $sql22 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs22 = mysql_query($sql22);
    ...
    $sql23 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$sql30 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs30 = mysql_query($sql30);
    ...
    $sql31 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs31 = mysql_query($sql31);
    ...
    $sql32 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$rs32 = mysql_query($sql32);
    ...
    $sql33 = "select pagetitle, retail_price, modx_site_tmplvar_ec_itemvalues.value, sell   from $dbase.`".$table_prefix."site_ec_items`, $dbase.`".$table_prefix."site_tmplvar_ec_itemvalues` 
...
$message.='
<form action="http://www.cddiski.ru/catalog/item?id='.$disc01.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<TABLE width=100% cellspacing=0 cellpadding=0 border=0  class=pad_null>
<tr>
<TD valign=top align=center  width="25%"><a href="http://www.cddiski.ru/catalog/item?id='.$disc21.'"><img border="0"  src=http://www.cddiski.ru/'.$pic21.' width="120"></a></TD>
...
<TR >
<TD valign=top align=center> <a href="http://www.cddiski.ru/catalog/item?id='.$disc31.'"><FONT size=2 face=Verdana color=#000000 ><b>'.$title31.'</b></a> <br></TD>
<TD valign=top align=center >&nbsp;</TD>
...
if ($_POST['sending']==1) $sql .="and sending_comp=1  "; 
else if  ($_POST['sending']==2) $sql .="and sending_video=1  "; 
else if ($_POST['sending']==3) $sql .="and sending_pr=1  ";  
...
$message.='
<TD valign=center align=center background="http://www.cddiski.ru/assets/templates/cd/i/sending_fon.jpg" height="46" >
<table class=pad_null><tr><td><img border=0 src=http://www.cddiski.ru/assets/templates/cd/i/in_cart2.gif  hspace=3 vspace=0 ></td>
<td>
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc02.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc03.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc04.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc21.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc22.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc23.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc24.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc31.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc32.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc33.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
...
<form action="http://www.cddiski.ru/catalog/item?id='.$disc34.'" method="POST" style="margin:0px;padding:0px;">
<input name=button3 class="tobasket" value="Посмотреть"  type=submit></form>';
