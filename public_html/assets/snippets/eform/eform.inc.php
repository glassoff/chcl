...
//return '<pre>'. var_export($params,true).'</pre>';
	...
	if (isset ($_POST['pub_guest'])&& $_POST['pub_guest']=='1' ) {
					$createdon=time();
			      $title=$_POST['subject'];
				  ...
				  $email=$_POST['email'];
				  $secip=$REMOTE_ADDR;
$query2 = "insert modx_jotgb_content (id, title, tagid, published, uparent, flags, secip, content, mode, createdon, reply) values
            ('', '$title', '', '1','1618', '', '$secip', '$content', '0','$createdon', '' ) ";
$result2 = mysql_query($query2);
$insert_id =mysql_insert_id();

$query3 = "insert modx_jotgb_fields (id, label, content) values
            ('$insert_id', 'name', ' $name' ) ";
$result3 = mysql_query($query3);

$query4 = "insert modx_jotgb_fields (id, label, content) values
            ('$insert_id', 'email', ' $email' ) ";
