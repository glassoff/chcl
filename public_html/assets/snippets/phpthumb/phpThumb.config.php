...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../../images/.phpthumb_cache/';                            // set the cache directory relative to the phpThumb() installation - assets/images/phpthumb_cache by default
