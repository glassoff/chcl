...
class WebLoginPE
{
	...
	$region = $modx->db->escape($modx->stripTags($_POST['region']));
		...
		" (internalKey,reg_date,fname,sname,lname, email, phone, region, town, street, house, korpus, kvartira, postcode1, type, company, opt) VALUES".
		" ('".$key."',".$reg_date.",'".$fname."', '".$sname."', '".$lname."', '".$email."', '".$phone."', '".$region."', '".$town."', '".$street."','".$house."','".$korpus."', '".$kvartira."','".$postcode1."','".$type."','".$company."','".$opt."')";
	...
	function SaveUserProfile($internalKey = '',$requiredFields = '')
	{
		...
		$generalElementsArray = array('fname','sname','lname','email','phone', 'town', 'street', 'house','korpus', 'kvartira', 'postcode1');
