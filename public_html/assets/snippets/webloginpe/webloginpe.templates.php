<?php
	...
	$wlpeProfileTpl = '<div class="message">[+wlpe.message+]</div>
	<div id="wlpeUser">
	...
	$wlpeProfileDeleteTpl = '<div class="message">[+wlpe.message+]</div>
	...
	$wlpeActivateTpl = '<div class="message">[+wlpe.message+]</div>
	<div id="wlpeActivate">
		<form id="wlpeActivateForm" name="wlpeActivateForm" action="[~[*id*]~]" method="POST">
			<fieldset id="wlpeActivateFieldset">
				...
				<input type="password" id="wlpeNewPasswordConfirm" name="newpasswordconfirm" />
				</label>
	...
	$wlpeResetTpl = '<div class="message">[+wlpe.message+]</div>
	<div id="wlpeReset">
	...
	$wlpeRegisterVerifyTpl = '<div class="message">[+wlpe.message+]</div>
	<div id="wlpeRegister">
	...
	$wlpeRegisterInstantTpl = '<div class="message">[+wlpe.message+]</div>
	<div id="wlpeNewUser">
	...
	$wlpeViewProfileTpl = '<div class="message">[+wlpe.message+]</div>
	...
	$wlpeUsersOuterTpl = '<div class="message">[+wlpe.message+]</div>
	...
	$wlpeManageProfileTpl = '<div class="message">[+wlpe.message+]</div>
	<div id="wlpeUser">
		<form enctype="multipart/form-data" id="wlpeUserProfileForm" action="[~[*id*]~]" method="POST">
			<fieldset id="wlpeUserProfileInput">
				<div id="wlpeUserInfo">
	...
	$wlpeManageDeleteTpl = '<div class="message">[+wlpe.message+]</div>
	<div id="wlpeProfileDelete">
		<form id="wlpeProfileDeleteForm" name="profileDelteForm" action="[~[*id*]~]" method="POST">
			<fieldset id="wlpeProfileDeleteFieldset">
	...
	$wlpeMessageTpl = '<div class="message">[+wlpe.message.text+]</div>';
	...
	$wlpeNotifyTpl = '
Здравствуйте, на сайте chcl.ru зарегистрирован новый пользователь.

Компания: [+type+] [+company+]
