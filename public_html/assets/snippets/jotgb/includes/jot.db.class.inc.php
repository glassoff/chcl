...
class CJotDataDb {
	...
	function CJotDataDb() {
		global $modx;
		$this->tbl["check"] = $modx->getFullTableName("jotgb_fields");
		$this->tbl["content"] = $modx->getFullTableName('jotgb_content');
		$this->tbl["subscriptions"] = $modx->getFullTableName('jotgb_subscriptions');
		$this->tbl["fields"] = $modx->getFullTableName('jotgb_fields');
